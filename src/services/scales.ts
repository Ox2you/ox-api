...
export type Scale = { pollutant: 'AOD'|'NO2', unit: string, bands: Band[] };
export const SCALES: Record<'AOD'|'NO2', Scale> = {
...
export function colorFor(pollutant: 'AOD'|'NO2', value: number) {
